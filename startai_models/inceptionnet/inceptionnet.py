...
from startai_models.inceptionnet.layers import (
...
class InceptionV3(BaseModel):
    """An Startai native implementation of InceptionNet"""
    ...
    def _build(self, *args, **kwargs):
        ...
        self.dropout = startai.Dropout(prob=self.spec.dropout)
        self.fc = startai.Linear(2048, self.spec.num_classes)

    @classmethod
    def get_spec_class(self):
        return InceptionNetSpec

    def _forward(self, x: startai.Array, data_format=None) -> List[startai.Array]:
