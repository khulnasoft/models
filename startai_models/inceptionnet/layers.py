...
class InceptionBasicConv2d(startai.Module):
    """
    ...
    def _build(self, *args, **kwargs):
        ...
        self.bn = startai.BatchNorm2D(self.out_channels, eps=0.001, training=False)
...
class InceptionAux(startai.Module):
    """
    ...
    def __init__(
        ...
        in_channels: int,
        num_classes: int,
        conv_block: Optional[Callable[..., startai.Module]] = None,
    ) -> None:
    ...
    def _build(self, *args, **kwargs):
        ...
        self.fc = startai.Linear(768, self.num_classes)
        self.fc.stddev = 0.001

    def _forward(self, x):
        # N x 768 x 17 x 17
        x = startai.avg_pool2d(x, (5, 5), (3, 3), "valid")
        ...
        x = startai.adaptive_avg_pool2d(x, (1, 1))
...
class InceptionA(startai.Module):
    """
    ...
    def _forward(self, x: startai.Array) -> List[startai.Array]:
        ...
        branch_pool = startai.avg_pool2d(x, (3, 3), (1, 1), ((1, 1), (1, 1)))

        branch_pool = self.branch_pool(branch_pool)

        outputs = [branch1x1, branch5x5, branch3x3dbl, branch_pool]
        outputs = startai.concat(outputs, axis=3)

        return outputs


class InceptionB(startai.Module):
    """
    ...
    def __init__(
        self, in_channels: int, conv_block: Optional[Callable[..., startai.Module]] = None
    ) -> None:
        if conv_block is None:
            self.conv_block = InceptionBasicConv2d
        self.in_channels = in_channels
    ...
    def _forward(self, x: startai.Array) -> List[startai.Array]:
        ...
        branch_pool = startai.max_pool2d(x, [3, 3], 2, 0)
...
class InceptionC(startai.Module):
    """
...
class InceptionD(startai.Module):
    """
...
class InceptionE(startai.Module):
    """
