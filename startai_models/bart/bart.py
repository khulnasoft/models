import startai
from startai_models.base import BaseModel
...
class BartEncoder(startai.Module):
    """
    ...
    ----
        config: BartConfig
        embed_tokens (startai.Embedding): output embedding
    """

    def __init__(
        self,
        config: BartConfig,
        embed_tokens: Optional[startai.Embedding] = None,
        v=None,
    ):
        self.training = True
        self.config = config
        ...
        self.embed_scale = startai.sqrt(embed_dim) if config.scale_embedding else 1.0
    ...
    def _build(self, *args, **kwargs):
        ...
        self.embed_tokens = startai.Embedding(
        ...
        self.layernorm_embedding = startai.LayerNorm(embed_dim)
    ...
    def _forward(
        self,
        input_ids: startai.Array = None,
        attention_mask: Optional[startai.Array] = None,
        head_mask: Optional[startai.Array] = None,
        inputs_embeds: Optional[startai.Array] = None,
        ...
        r"""
        Args:
            input_ids (`startai.Array` of shape `(batch_size, sequence_length)`):
            ...
            attention_mask (`startai.Array` of shape
            ...
            head_mask (`startai.Array` of shape
            ...
            inputs_embeds (`startai.FloatTensor` of shape
        ...
        if input_ids is not None and inputs_embeds is not None:
            ...
            input = input_ids
            input_ids = startai.reshape(input_ids, (-1, input_ids.shape[-1]))
        ...
        hidden_states = startai.functional.dropout(
        ...
        for idx, encoder_layer in enumerate(self.layers):
            ...
            to_drop = False
            if self.training:
                dropout_probability = startai.random_uniform(low=0, high=1)
...
class BartDecoder(startai.Module):
    """
    ...
    def __init__(
        ...
        self.embed_scale = startai.sqrt(config.d_model) if config.scale_embedding else 1.0
    ...
    def _build(self, *args, **kwargs):
        ...
        self.layernorm_embedding = startai.LayerNorm(self.config.d_model)
    ...
    def _forward(
        ...
        head_mask: Optional[startai.Array] = None,
        cross_attn_head_mask: Optional[startai.Array] = None,
        past_key_values: Optional[List[startai.Array]] = None,
        inputs_embeds: Optional[startai.Array] = None,
        ...
        Args:
            ...
            `(batch_size, sequence_length)`, *optional*):
                ...
                [What are attention masks?](../glossary#attention-mask)
            encoder_hidden_states (`startai.Array` of shape
            ...
            encoder_attention_mask (`startai.Array` of shape
            ...
            cross_attn_head_mask (`startai.Array` of shape
            `(decoder_layers, decoder_attention_heads)`, *optional*):
            ...
            past_key_values (`tuple(tuple(startai.Array))`, *optional*, returned when
            `use_cache=True` is passed or when `config.use_cache=True`):
                Tuple of `tuple(startai.Array)` of length `config.n_layers`,
                ...
                `(batch_size, sequence_length)`. inputs_embeds (`startai.Array` of shape
                `(batch_size, sequence_length, hidden_size)`, *optional*):
        ...
        if input_ids is not None and inputs_embeds is not None:
            ...
            input_ids = startai.reshape(input_ids, (-1, input_shape[-1]))
        elif inputs_embeds is not None:
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if self.training:
                dropout_probability = startai.random_uniform([])
...
class BartModel(BaseModel):
    ...
    def _build(self, *args, **kwargs):
        ...
        self.shared = startai.Embedding(vocab_size, self.config.d_model, padding_idx)
    ...
    def _forward(
        ...
        input_ids: startai.Array = None,
        attention_mask: Optional[startai.Array] = None,
        decoder_input_ids: Optional[startai.Array] = None,
        decoder_attention_mask: Optional[startai.Array] = None,
        head_mask: Optional[startai.Array] = None,
        decoder_head_mask: Optional[startai.Array] = None,
        cross_attn_head_mask: Optional[startai.Array] = None,
        encoder_outputs: Optional[List[startai.Array]] = None,
        past_key_values: Optional[List[startai.Array]] = None,
        inputs_embeds: Optional[startai.Array] = None,
        decoder_inputs_embeds: Optional[startai.Array] = None,
        use_cache: Optional[bool] = None,
        output_attentions: Optional[bool] = None,
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
