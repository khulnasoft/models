...
from startai_models.googlenet.layers import (
    InceptionConvBlock,
    InceptionBlock,
...
class GoogLeNet(BaseModel):
    ...
    def _build(self, *args, **kwargs):
        ...
        self.pool6 = startai.AdaptiveAvgPool2d([1, 1])

        self.dropout = startai.Dropout(self.spec.dropout)
        self.fc = startai.Linear(1024, self.spec.num_classes, with_bias=True)
    ...
    def _forward(self, x, data_format=None):
        ...
        out = self.conv1(x)
        out = startai.max_pool2d(out, [3, 3], 2, 0, ceil_mode=True, data_format="NCHW")
        out = self.conv2(out)
        out = self.conv3(out)
        out = startai.max_pool2d(out, [3, 3], 2, 0, ceil_mode=True, data_format="NCHW")
        ...
        out = startai.max_pool2d(out, [2, 2], 2, 0, ceil_mode=True, data_format="NCHW")
