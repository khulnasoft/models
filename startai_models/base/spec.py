...
class BaseSpec:
    ...
    def from_dict(self, config_dict: dict):
        if not isinstance(config_dict, dict):
            raise startai.exceptions.StartaiException("`config_dict` must be a Python dict.")
    ...
    def from_json_file(self, json_file: str):
        ...
        try:
            ...
            raise startai.exceptions.StartaiException("File is not a valid JSON document.")
